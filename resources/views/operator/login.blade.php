...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('panel/assets/images/icon/favicon.ico')}}">
        ...
        <div class="container">
            <div class="login-box ptb--100">
                @if (session()->has('alert'))
                    <div class="alert alert-danger alert-block" style="width: 50%;position: absolute;">
                ...
                <form method="POST" action="/operator/login">
                    ...
                    <div class="login-form-head">
                        <h4>Sign In</h4>
                        <p>Hello there, Sign in and start managing your Operator Dashboard</p>
                    </div>
