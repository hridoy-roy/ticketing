        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Trip Detail</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="/dashboard">Home</a></li>
                        <li><span>Trip Detail</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <table class="text-center table table-bordered table-striped">
                    <thead>
                        ...
                        <th class="">Ratings</th>
                        <th class="">Fare</th>
                        <th class=" ">Seats Available</th>
                    </thead>
                    <tbody>
                        <tr class="">

                            <td class="">
                                <p class=""><strong>{{$trip->Bus->Operator->name}}</strong></p>
                                <p class="">{{$trip->Bus->bus_type}} A/C Sleeper (2+1)</p>
                            </td>
                            <td class="">{{$trip->travel_date}}<br>{{$trip->departure_time}}<br><small class="busty">{{$trip->depart_from}}</small></td>
                            <td class="">
                                <?php
                                    ...
                                    @foreach ($trip->Bookings as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="modal-secondar-{{ $booking->id }}">
